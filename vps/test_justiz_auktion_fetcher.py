...
Getriebeart: Automatik<br>Fahrbereit: Ja</p></div></html>
"""
...
class JustizTests(unittest.TestCase):
    ...
    def test_detail(self) -> None:
        row = module.parse_detail(DETAIL, "https://www.justiz-auktion.de/VW-Golf-211755",
    ...
    def test_conflicting_old_baujahr_fails_closed(self) -> None:
        ...
        self.assertIsNone(module.parse_detail(markup, "https://www.justiz-auktion.de/VW-Golf-211755",
                                              now=dt.datetime(2026, 1, 1, tzinfo=dt.timezone.utc)))
