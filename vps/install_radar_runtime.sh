...
install -m 0755 "$SOURCE/autorola_official_watch.py" /opt/sonardeals-radar/autorola_official_watch.py
...
install -m 0755 "$SOURCE/aurena_official_watch.py" /opt/sonardeals-radar/aurena_official_watch.py
...
install -m 0755 "$SOURCE/klaravik_official_watch.py" /opt/sonardeals-radar/klaravik_official_watch.py
